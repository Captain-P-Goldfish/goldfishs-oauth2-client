...
export function HttpClientMenu(props)
{
    ...
    useEffect(() =>
              {
                  ...
                  scimClient.listResources({
                                               ...
                                               onSuccess: listResponse => setMenuEntries(
    ...
    {
        let selectedEntry = lodash.find(menuEntries, function (entry)
        {
            if (entry.name === menuEntry)
            {
                return true;
            }
        })
        props.selectMenuEntry(selectedEntry);
    }
    ...
    function onMenuEntryAdd(menuEntry)
    {
        ...
        scimClient.createResource(HTTP_REQUEST_GROUPS_ENDPOINT,
                                  categoryResource,
