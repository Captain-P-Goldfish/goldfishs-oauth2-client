...
export default class AccessTokenView extends React.Component
{
    ...
    {
        let responseDetails = (this.props.accessTokenDetails || {});
    ...
    {
        return <React.Fragment>
            <Button type="submit" onClick={this.props.retrieveAccessTokenDetails}
                    style={{marginTop: "15px", marginBottom: "15px"}}>
                <LoadingSpinner show={this.props.isLoading} /> Get Access Token
            </Button>
            {this.props.accessTokenDetails && this.loadAccessTokenView()}
        </React.Fragment>
    }
}
