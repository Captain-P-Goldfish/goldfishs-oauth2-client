...
import {Collapseable, ErrorListItem, JwsOffCanvas} from "../../base/form-base";
...
export default function AccessTokenView(props)
{
  return <div className={"grant-type-workflow"}>
    <AccessTokenCollapsible
      ...
      content={() =>
      {
        return <AccessTokenDetailsView metaData={props.metaData} accessTokenDetails={props.accessTokenDetails}/>;
      }}
