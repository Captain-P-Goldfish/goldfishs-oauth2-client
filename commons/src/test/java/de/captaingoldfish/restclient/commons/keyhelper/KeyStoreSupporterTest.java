package de.captaingoldfish.restclient.commons.keyhelper;
...
import de.captaingoldfish.restclient.commons.FileReferences;
import de.captaingoldfish.restclient.commons.exceptions.KeyStoreCreationFailedException;
import de.captaingoldfish.restclient.commons.exceptions.KeyStoreEntryException;
import de.captaingoldfish.restclient.commons.exceptions.KeystoreEntryExistsException;
 ...
 * <br>
 */
public class KeyStoreSupporterTest implements FileReferences
{
  ...
  {
    KeyStore keyStore = KeyStoreSupporter.readTruststore(getClass().getResourceAsStream(UNIT_TEST_JKS),
                                                         KeyStoreSupporter.KeyStoreType.JKS);
  ...
  public void testReadTruststoreFromBytes()
  {
    ...
    try (InputStream inputStream = getClass().getResourceAsStream(UNIT_TEST_TRUSTSTORE_JKS))
    {
  ...
  {
    byte[] truststoreBytes;
    try (InputStream inputStream = getClass().getResourceAsStream(UNIT_TEST_PKCS12))
    {
      truststoreBytes = IOUtils.toByteArray(inputStream);
    }
  ...
  {
    KeyStore keyStore = KeyStoreSupporter.readTruststore(getClass().getResourceAsStream(UNIT_TEST_PKCS12),
                                                         KeyStoreSupporter.KeyStoreType.PKCS12,
                                                         "123456");
    Assertions.assertNotNull(keyStore);
  }
  ...
  {
    InputStream keystoreStream = getClass().getResourceAsStream(UNIT_TEST_PKCS12);
  ...
  {
    InputStream keystoreStream = getClass().getResourceAsStream(UNIT_TEST_NO_PASSWORD_PKCS12);
  ...
  {
    KeyStore ks = KeyStoreSupporter.readTruststore(getClass().getResourceAsStream(UNIT_TEST_NO_PASSWORD_PKCS12),
                                                   KeyStoreSupporter.KeyStoreType.PKCS12,
                                                   "");
    Assertions.assertNotNull(ks);
  }
  ...
  {
    KeyStore ks = KeyStoreSupporter.readTruststore(getClass().getResourceAsStream(UNIT_TEST_JCEKS),
                                                   KeyStoreSupporter.KeyStoreType.JCEKS);
    Assertions.assertNotNull(ks);
  }
  ...
  {
    KeyStore keyStore = KeyStoreSupporter.readTruststore(getClass().getResourceAsStream(UNIT_TEST_JCEKS),
                                                         KeyStoreSupporter.KeyStoreType.JCEKS);
