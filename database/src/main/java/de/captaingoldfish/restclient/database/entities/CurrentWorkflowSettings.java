...
public class CurrentWorkflowSettings
{
   ...
   */
  @Id
  @GeneratedValue(generator = "CURRENT_WORKFLOW_SETTINGS_SEQ")
  @SequenceGenerator(name = "CURRENT_WORKFLOW_SETTINGS_SEQ", sequenceName = "hibernate_sequence", allocationSize = 1)
  @Column(name = "ID")
  private long id;
