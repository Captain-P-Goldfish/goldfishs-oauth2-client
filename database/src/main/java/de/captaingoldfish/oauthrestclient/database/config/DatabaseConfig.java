package de.captaingoldfish.oauthrestclient.database.config;
...
public class DatabaseConfig
{
   ...
   */
  protected static final String PACKAGE_TO_SCAN = "de.captaingoldfish.oauthrestclient.database";
  ...
  protected SpringLiquibase liquibase(DataSource dataSource)
  {
    ...
    liquibase.setChangeLog("classpath:/de/captaingoldfish/oauthrestclient/database/liquibase/changelog.xml");
    return liquibase;
  }
