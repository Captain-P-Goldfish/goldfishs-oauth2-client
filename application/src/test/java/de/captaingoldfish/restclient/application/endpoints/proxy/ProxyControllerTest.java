...
public class ProxyControllerTest extends AbstractOAuthRestClientTest
{
  ...
  // List<String> portErrors = errorResponseForm.getInputFieldErrors().get("port");
  // Assertions.assertEquals(1, portErrors.size());
  // MatcherAssert.assertThat(portErrors, Matchers.containsInAnyOrder("Port must be within range of '1' and
  // '65535'"));
  // }
  //
  // @Test
  ...
  // {
  // Proxy proxy = Proxy.builder().host("localhost").port(port).username("goldfish").password("123456").build();
  // proxyDao.save(proxy);
  // }
  //
  ...
  // Assertions.assertEquals(newHost, dbProxy.getHost());
  // Assertions.assertEquals(newPort, String.valueOf(dbProxy.getPort()));
  // Assertions.assertEquals(newUsername, dbProxy.getUsername());
  // Assertions.assertEquals(newPassword, dbProxy.getPassword());
  // }
  //
  // @Test
  ...
  // MatcherAssert.assertThat(errorResponse.getErrorMessages(), Matchers.hasItem("Cannot update proxy for empty
  // ID"));
  //
  ...
  // ProxyUpdateForm updateForm =
  // ProxyUpdateForm.builder().id(unknownProxyId).host("127.0.0.1").port("7777").build();
  //
  // HttpResponse<JsonNode> response = Unirest.put(getApplicationUrl("/proxy/update"))
  // .contentType(MediaType.APPLICATION_JSON_VALUE)
  // .body(updateForm)
  ...
  // Assertions.assertNotNull(errorResponse.getErrorMessages());
  // Assertions.assertEquals(1, errorResponse.getErrorMessages().size());
  // MatcherAssert.assertThat(errorResponse.getErrorMessages(), Matchers.hasItem("Cannot delete proxy for empty
  // ID"));
  // }
  //
  // @Test
